...
DREIATTEST_GOOGLE_ALLOW_NON_PLAY_INSTALLS = getattr(settings, 'DREIATTEST_GOOGLE_ALLOW_NON_PLAY_INSTALLS', False)
...
DREIATTEST_GOOGLE_REQUIRED_DEVICE_VERDICT = getattr(settings, 'DREIATTEST_GOOGLE_REQUIRED_DEVICE_VERDICT', 'MEETS_DEVICE_INTEGRITY')
