...
def get(app_id: str, nonce: Nonce, device_session: DeviceSession, aaguid: bytes = b'appattestdevelop', counter: int = 0,
    ...
    attest_nonce = (str(device_session) + public_key_base64.decode() + nonce.value).encode()
